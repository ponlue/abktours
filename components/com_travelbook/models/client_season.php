 ...
 *
 * @version         $Id: client_season.php 2 2010-04-13 13:37:46Z WEB $
 ...
 */
class TravelbookModelClient_Season extends JModel
{
	/**
	 * Guest data array
	 *
 ...
 */
	...
	function store($data)
	{
		...
		$row =& $this->getTable('client_season');
/*** Bind the form fields to the ClientSeason table ***/
		if (!$row->bind($data)) {
