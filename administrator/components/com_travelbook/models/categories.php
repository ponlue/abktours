...
class TravelbooksModelCategories extends JModel
{
	/**
...
//	. ' AND ( checked_out = 0 OR ( checked_out = '. (int) $user->get('id') .' ) )'
	...
	$mainframe->redirect( 'index.php?option=com_travelbook&task=categories.show' );
}
...
*/
function orderCategories( $uid, $inc )
{
	global $mainframe;
	...
	$mainframe->redirect( 'index.php?option=com_travelbook&task=categories.show', $msg );
}
 ...
 */
	...
	*/
	...
	// get the subset (based on limits) of required records
		...
		. ' FROM (#__tb_dat_cnt INNER JOIN #__tb_season ON #__tb_dat_cnt.dat_id = #__tb_season.id) INNER JOIN #__tb_journey ON #__tb_season.jrn_id = #__tb_journey.id'
		. ' WHERE (((#__tb_dat_cnt.cnt_id)= '.$this->_tid.'))' 
