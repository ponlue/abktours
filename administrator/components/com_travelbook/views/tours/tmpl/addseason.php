 ...
 *
 * @version         $Id: addseason.php 2 2010-04-13 13:37:46Z WEB $
...
function submitbutton(pressbutton) {
	...
	if (pressbutton == 'tours.canceladdseason') {
...
<div class="col width-50">
	<fieldset class="adminform">
		<legend><?php echo JText::_( 'TB New Season' ); ?></legend>
		...
		<tr>
			...
			<td>
				...
				<input type="hidden" name="jrn_id" value="<?php echo $this->tour->id;?>" />
			</td>
		</tr>
		<tr>
			<td class="key">
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="arrival" id="arrival" size="10" maxlength="10" value="<?php echo JHTML::_('date', $this->season->departure, JText::_('DATE_FORMAT_TB1'));?>" />
				<script type="text/javascript">
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="rate" id="rate" size="8" maxlength="8" value="<?php echo $this->season->rate; ?>" />
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="single_supplement" id="single_supplement" size="8" maxlength="8" value="<?php echo $this->season->single_supplement; ?>" />
			</td>
		</tr>
