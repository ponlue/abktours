...
INSERT INTO `#__flippingbook_config` VALUES (18, 'version', '1.5.11');
...
INSERT INTO `#__flippingbook_pages` VALUES (1, 'my-book_01.swf', 1, '<strong>Page 1. New features:</strong>- SEO version. HTML version for search engine indexing, non-flash computers and mobile devices<br />- RTL books support<br />- Ability to bind a desired page to a menu item<br /><em>You can modify this text in administration back-end (Components &gt; FlippingBook &gt; Manage Pages &gt; page properties &gt; Description).</em>', 1, 1, '', '', 800, 600, 0, 0);
