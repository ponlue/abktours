...
<table cellpadding="0" cellspacing="3" border="0" id="toolbar">
	...
	function custom( $task='', $icon=NULL, $iconOver='', $alt='', $listSelect=true ) {
		...
		?>
		<td><a class="toolbar" onclick="<?php echo $onclick ;?>"> <?php echo $image; ?></a>
		</td>
		<?php
	}
	...
	function preview( $popup='' ) {
		...
		?>
		<td><a class="toolbar"
			onclick="window.open('popups/<?php echo $popup;?>.php?t=<?php echo $cur_template; ?>', 'win1', 'status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no');">
			<?php echo $image; ?></a></td>
			<?php
	}
	...
	function back() {
		...
		?>
		<td><a class="toolbar" href="javascript:window.history.back();"> <?php echo $image;?></a>
		</td>
		<?php
	}
	...
	function media_manager( $directory = '' ) {
		...
		?>
		<td><a class="toolbar"
			onclick="popupWindow('popups/uploadimage.php?directory=<?php echo $directory; ?>','win1',250,100,'no');">
			<?php echo $image; ?></a></td>
			<?php
	}
