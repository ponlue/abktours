...
class mosHTML
{
	...
	function CloseButton ( &$params, $hide_js=NULL )
	{
		...
		if ( $params->get( 'popup' ) && !$hide_js ) {
			?>
<div align="center" style="margin-top: 30px; margin-bottom: 30px;"><script
	...
	function BackButton ( &$params, $hide_js=NULL )
	{
		...
		if ( $params->get( 'back_button' ) && !$params->get( 'popup' ) && !$hide_js) {
			?>
<div class="back_button"><a href='javascript:history.go(-1)'> <?php echo JText::_( 'BACK' ); ?></a>
</div>
			<?php
		}
	}
...
<td align="right" width="100%" class="buttonheading"><a
	...
	title="<?php echo JText::_( 'Print' );?>"> <?php echo $image;?></a></td>
				<?php
			}
		}
	}
