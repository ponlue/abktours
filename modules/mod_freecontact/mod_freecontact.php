...
<form id="freeContactForm" method="post" class="form-validate"
	onSubmit="return myfreeContactValidate(this);"
	action="<?php echo $_SERVER['REQUEST_URI']; ?>"><input type="text"
	name="name" value="Your Name" onFocus="clearfreeContactText(this)"
	class="freeContactText" /> <br />
<input type="text" name="email" value="Email"
	onFocus="clearfreeContactText(this)"
	class="freeContactText required validate-email" /> <br />
<input type="text" name="Phone" value="Phone"
	onFocus="clearfreeContactText(this)" class="freeContactText" /> <br />
<textarea name="text" class="freeContactTextarea"></textarea> <br />
<input type="submit" value="<?php echo $lsSubmitText; ?>"
	class="freeContactButton" /> <input type="hidden"
	name="freeContactAction" value="send" /> <input type="hidden"
	name="check" value="post" /></form>
...
<div class="tiflo"><a href="http://webdesignsim.com/">κατασκευή
ιστοσελίδων</a></div>
