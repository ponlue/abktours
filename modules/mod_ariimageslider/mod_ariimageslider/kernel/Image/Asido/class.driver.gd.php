...
if (!defined('ASIDO_GD_PNG_QUALITY')) {
	define('ASIDO_GD_PNG_QUALITY', floor(abs(99 - ASIDO_GD_JPEG_QUALITY) / 10));
}
	...
	function __write(&$tmp) {
		...
		switch($tmp->save) {
			...
			case 'image/png' :
				...
				$result = @imagePNG($tmp->target, $tmp->target_filename, ASIDO_GD_PNG_QUALITY);
				break;
		}
