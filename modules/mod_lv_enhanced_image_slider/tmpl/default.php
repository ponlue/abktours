...
<script
	...
	src="modules/mod_lv_enhanced_image_slider/js/jquery-1.4.4.min.js"></script>
<script
	type="text/javascript"
	src="modules/mod_lv_enhanced_image_slider/js/jquery.cycle.all.min.js"></script>
<?php }; ?>
<?php if ($useCompression == 1) {?>
<script
	type="text/javascript"
	src="modules/mod_lv_enhanced_image_slider/js/js_compress.php"></script>
<?php }; ?>
...
<noscript>You need Javascript enabled in your browser to see sliding
images...</noscript>
...
<?php if ($useNav == 1) {?>
<div class="lveisnav"><?php if ($nextbutton == 1) {?> <a
	href="javascript:void(0);" class="next">Next</a> <?php }; ?> <?php if ($prevbutton == 1) {?>
<a href="javascript:void(0);" class="prev">Prev</a> <?php }; ?> <?php if ($lveisindex == 1) {?>
