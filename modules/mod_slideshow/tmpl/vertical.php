...
<script
	src="<?php echo JURI::root(); ?>modules/mod_slideshow/scripts/vertical.js"
	type="text/javascript"></script>

<div id="marqueecontainer" onMouseover="copyspeed=pausespeed"
	onMouseout="copyspeed=marqueespeed">
<div id="vmarquee"
	style="text-align: center; position: absolute; width: 98%;"><?php for ( $i=0 ; $i < count($this->image) ; $i++ ) echo str_replace ( '\/', '/', $this->slideshowcontent[$i] ).'<div style="display: block; height:'.$this->space.'px;"></div>'; ?>
</div>
</div>
