...
?>
<?php ob_start(); ?>
// JAVASCRIPT VARS // cache buster var cacheBuster = "?t=" +
Date.parse(new Date()); // stage dimensions var stageW = "
<?php echo $width; ?>
";//"100%"; var stageH = "
<?php echo $height; ?>
";//"100%"; // ATTRIBUTES var attributes = {}; attributes.id = 'placid
<?php echo $module->id; ?>
'; attributes.name = 'placid
<?php echo $module->id; ?>
'; // PARAMS var params = {}; params.bgcolor = "#ffffff"; params.menu =
"false"; params.scale = 'noScale'; params.wmode = "opaque";
params.allowfullscreen = "true"; params.allowScriptAccess = "always"; /*
FLASH VARS */ var flashvars = {}; /// if commented / delete these lines,
the component will take the stage dimensions defined /// above in
"JAVASCRIPT SECTIONS" section or those defined in the settings xml
flashvars.componentWidth = stageW; flashvars.componentHeight = stageH;

/// path to the content folder(where the xml files, images or video are
nested) /// if you want to use absolute paths(like
"http://domain.com/images/....") then leave it empty("")
flashvars.pathToFiles = ""; // path to content XML flashvars.xmlPath =
"modules/mod_the_placid/banner/xml/banner
<?php echo $module->id; ?>
.xml"; /** EMBED THE SWF**/
swfobject.embedSWF("modules/mod_the_placid/preview.swf"+cacheBuster,
attributes.id, stageW, stageH, "9.0.124",
"modules/mod_the_placid/js/expressInstall.swf", flashvars, params,
attributes);
